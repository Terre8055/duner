...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Michael Appiah Dankwah</h2>;
  const three = <h3 className="big-heading">With me, features are deployed now!</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="https://medium.com/@michaeladev"
      target="_blank"
      rel="noreferrer">
